...
export const Item = ({
    ...
    const onArchive = (event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
        ...
        toast.promise(promise, {
            ...
            success: "asignatura movida a la papelera!",
            error: "Error al archivar la asignatura.",
        });
    };
    ...
    const onCreate = (event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
        ...
        const promise = create({ title: "Sin título", parentDocument: id }).then(
            (documentId) => {
                if (!expanded) {
                    onExpand?.();
                }
        ...
        toast.promise(promise, {
            loading: "Creando nueva asignatura",
                    ...
                    <DropdownMenu>
                        ...
                        >
                            ...
                            <div className="p-2 text-xs text-muted-foreground">
                                Última edición por: {user?.fullName}
                            </div>
                        </DropdownMenuContent>
                    </DropdownMenu>
                    <div
